    ...
    public class MainViewModel : ViewModelBase
    {
        ...
        public double RightThumbStickX
        {
            ...
            set
            {
                if (rightThumbStickX != value)
                {
                    ...
                    // Update the robot model
                    RobotModel.TurnHeadCommand = (int)(rightThumbStickX * 1000);
                }
            }
        }
        ...
        public string RobotIpAddress
        {
            ...
            set
            {
                ...
                RaisePropertyChanged();
                RaisePropertyChanged("RobotCameraStreamAddress");
        ...
        /// <summary>
        /// Gets the RobotCameraStreamAddress
        /// </summary>
        public string RobotCameraStreamAddress
        {
            get => "http://" + RobotIpAddress + ":8080/stream_simple.html";
        }
